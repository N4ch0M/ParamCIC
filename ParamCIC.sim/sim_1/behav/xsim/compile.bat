...
REM
REM Generated by Vivado on Wed Mar 26 20:45:33 -0300 2025
...
echo "xvlog --incr --relax -prj cic_int_tb_vlog.prj"
call xvlog  --incr --relax -prj cic_int_tb_vlog.prj -log xvlog.log
