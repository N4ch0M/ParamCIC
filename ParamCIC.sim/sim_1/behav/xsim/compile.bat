...
REM
REM Generated by Vivado on Sun Mar 30 20:37:07 -0300 2025
...
echo "xvlog --incr --relax -prj cic_int_comp_tb_vlog.prj"
call xvlog  --incr --relax -prj cic_int_comp_tb_vlog.prj -log xvlog.log
